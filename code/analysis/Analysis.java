...
public interface Analysis extends Switch
{
    ...
    void caseALocalDeclOtherStmt(ALocalDeclOtherStmt node);
    void caseAAssignmentOtherStmt(AAssignmentOtherStmt node);
    void caseAMethodCallOtherStmt(AMethodCallOtherStmt node);
    void caseAReturnVoidOtherStmt(AReturnVoidOtherStmt node);
    void caseAReturnExprOtherStmt(AReturnExprOtherStmt node);
    void caseABlockOtherStmt(ABlockOtherStmt node);
    void caseAWhileLoopOtherStmt(AWhileLoopOtherStmt node);
    void caseADoWhileLoopOtherStmt(ADoWhileLoopOtherStmt node);
    void caseANoStatementOtherStmt(ANoStatementOtherStmt node);
    void caseAMatchedIfStmt(AMatchedIfStmt node);
    void caseAUnmatchedIfStmt(AUnmatchedIfStmt node);
    void caseAMatchedIfDefMatchedIf(AMatchedIfDefMatchedIf node);
    void caseAOtherStmtMatchedIf(AOtherStmtMatchedIf node);
    void caseAUnmatchedIfWithoutElseUnmatchedIf(AUnmatchedIfWithoutElseUnmatchedIf node);
    void caseAUnmatchedElseWithElseUnmatchedIf(AUnmatchedElseWithElseUnmatchedIf node);
    ...
    void caseAOrOperationExpr(AOrOperationExpr node);
    void caseAMissingOrExpr(AMissingOrExpr node);
    void caseAAndOperationAndOperation(AAndOperationAndOperation node);
    void caseAGreaterLessEqualOperationAndOperation(AGreaterLessEqualOperationAndOperation node);
    void caseAEqualsComparisonEqualityOperation(AEqualsComparisonEqualityOperation node);
    void caseANotEqualsComparisonEqualityOperation(ANotEqualsComparisonEqualityOperation node);
    void caseANoEqualityOperationEqualityOperation(ANoEqualityOperationEqualityOperation node);
    void caseALessThanGreaterLessEqualOperation(ALessThanGreaterLessEqualOperation node);
    void caseAGreaterThanGreaterLessEqualOperation(AGreaterThanGreaterLessEqualOperation node);
    void caseALessThanOrEqGreaterLessEqualOperation(ALessThanOrEqGreaterLessEqualOperation node);
    void caseAGreaterThanOrEqGreaterLessEqualOperation(AGreaterThanOrEqGreaterLessEqualOperation node);
    void caseAPlusMinusExprGreaterLessEqualOperation(APlusMinusExprGreaterLessEqualOperation node);
