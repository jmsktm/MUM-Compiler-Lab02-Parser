...
public interface Analysis extends Switch
{
    ...
    void caseALocalDeclOther(ALocalDeclOther node);
    void caseAAssignmentOther(AAssignmentOther node);
    void caseAMethodCallOther(AMethodCallOther node);
    void caseAReturnVoidOther(AReturnVoidOther node);
    void caseAReturnExprOther(AReturnExprOther node);
    void caseABlockOther(ABlockOther node);
    void caseAWhileLoopOther(AWhileLoopOther node);
    void caseADoWhileLoopOther(ADoWhileLoopOther node);
    void caseANoStatementOther(ANoStatementOther node);
    void caseAAs1S(AAs1S node);
    void caseAAs2S(AAs2S node);
    void caseAAm1M(AAm1M node);
    void caseAAm2M(AAm2M node);
    void caseAAu1U(AAu1U node);
    void caseAAu2U(AAu2U node);
