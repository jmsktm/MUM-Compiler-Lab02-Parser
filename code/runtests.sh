...
echo "java ParserDriver tests/in01.cp" > output.txt
java ParserDriver tests/in01.cp >> output.txt
echo "" >> output.txt
echo "" >> output.txt
echo "" >> output.txt

echo "java ParserDriver tests/in02.cp" >> output.txt
java ParserDriver tests/in02.cp >> output.txt
echo "" >> output.txt
echo "" >> output.txt
echo "" >> output.txt

echo "java ParserDriver tests/in03.cp" >> output.txt
java ParserDriver tests/in03.cp >> output.txt
echo "" >> output.txt
echo "" >> output.txt
echo "" >> output.txt

echo "java ParserDriver tests/in04.cp" >> output.txt
java ParserDriver tests/in04.cp >> output.txt
echo "" >> output.txt
echo "" >> output.txt
echo "" >> output.txt

echo "java ParserDriver tests/in05.cp" >> output.txt
java ParserDriver tests/in05.cp >> output.txt
echo "" >> output.txt
echo "" >> output.txt
echo "" >> output.txt

echo "java ParserDriver tests/in06.cp" >> output.txt
java ParserDriver tests/in06.cp >> output.txt
echo "" >> output.txt
echo "" >> output.txt
echo "" >> output.txt

echo "java ParserDriver tests/in07.cp" >> output.txt
java ParserDriver tests/in07.cp >> output.txt
echo "" >> output.txt
echo "" >> output.txt
echo "" >> output.txt

echo "java ParserDriver tests/in08.cp" >> output.txt
java ParserDriver tests/in08.cp >> output.txt
echo "" >> output.txt
echo "" >> output.txt
echo "" >> output.txt

echo "java ParserDriver tests/in09.cp" >> output.txt
java ParserDriver tests/in09.cp >> output.txt
echo "" >> output.txt
echo "" >> output.txt
echo "" >> output.txt

echo "java ParserDriver tests/in10.cp" >> output.txt
