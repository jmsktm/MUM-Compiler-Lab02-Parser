...
public final class AClassDeclClassDecl extends PClassDecl
{
    ...
    public Object clone()
    {
        return new AClassDeclClassDecl(
    ...
    {
        ((Analysis) sw).caseAClassDeclClassDecl(this);
    }
