...
public final class AMultClassDeclsClassDecls extends PClassDecls
{
    private PClassDecls _classDecls_;
    private PClassDecl _classDecl_;

    public AMultClassDeclsClassDecls()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMultClassDeclsClassDecls(
    ...
    {
        ((Analysis) sw).caseAMultClassDeclsClassDecls(this);
    }
