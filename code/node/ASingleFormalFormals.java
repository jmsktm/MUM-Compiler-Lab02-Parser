...
public final class ASingleFormalFormals extends PFormals
{
    private PFormal _formal_;

    public ASingleFormalFormals()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ASingleFormalFormals(
    ...
    {
        ((Analysis) sw).caseASingleFormalFormals(this);
    }
