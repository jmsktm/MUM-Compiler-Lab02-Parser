...
public final class AMultClassDeclClassDecls extends PClassDecls
{
    private PClassDecls _classDecls_;
    private PClassDecl _classDecl_;

    public AMultClassDeclClassDecls()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMultClassDeclClassDecls(
    ...
    {
        ((Analysis) sw).caseAMultClassDeclClassDecls(this);
    }
