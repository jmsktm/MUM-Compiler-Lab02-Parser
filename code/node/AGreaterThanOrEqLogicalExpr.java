...
public final class AGreaterThanOrEqLogicalExpr extends PLogicalExpr
{
    ...
    public Object clone()
    {
        return new AGreaterThanOrEqLogicalExpr(
    ...
    {
        ((Analysis) sw).caseAGreaterThanOrEqLogicalExpr(this);
    }
