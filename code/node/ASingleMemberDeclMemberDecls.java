...
public final class ASingleMemberDeclMemberDecls extends PMemberDecls
{
    private PMember _member_;

    public ASingleMemberDeclMemberDecls()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ASingleMemberDeclMemberDecls(
    ...
    {
        ((Analysis) sw).caseASingleMemberDeclMemberDecls(this);
    }
