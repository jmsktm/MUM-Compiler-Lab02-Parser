...
public final class ADoWhileLoopOtherStmt extends POtherStmt
{
    private TDo _do_;
    ...
    public Object clone()
    {
        return new ADoWhileLoopOtherStmt(
            cloneNode(this._do_),
    ...
    {
        ((Analysis) sw).caseADoWhileLoopOtherStmt(this);
    }
